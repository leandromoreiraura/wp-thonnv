...
<body <?php body_class(); ?>>
	<div id="out">
    	...
    	<div id="hd">
            ...
            <ul id="tpmn">
            	<li id="cts"><a href="JavaScript:;" onclick="toggle_visibility('top-menu'); changeCssClass('cts'); getElementById('top-menu2').style.display='none'; getElementById('pg').setAttribute('class', '');"><b>Danh mục</b></a></li>
